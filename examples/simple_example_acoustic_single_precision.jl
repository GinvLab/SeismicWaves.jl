...
function exacouprob(parall=:Metal)
    ...
    # shots definition
    nshots = 6
    shots = Vector{ScalarShot{Float32}}()  #Pair{Sources, Receivers}}()
    ...
    snapevery = 50
    infoevery = 500
    boundcond = CPMLBoundaryConditionParameters(; halo=20, rcoef=0.0001f0, freeboundtop=true)
    ...
    shots_grad = Vector{ScalarShot{Float32}}()
    for i in 1:nshots
    ...
    newvelmod = matprop.vp .- 0.2f0
    newvelmod[30:40, 33:44] *= 0.9f0
