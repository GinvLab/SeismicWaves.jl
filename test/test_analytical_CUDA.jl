...
with_logger(error_logger) do
    @testset "Test 1D analytical solution" begin
        ...
        @testset "Test constant velocity (1000 m/s) halo 0" begin
            ...
            # numerical solution
            swforward!(params, vel, [srcs => recs]; parall=:GPU)
        ...
        @testset "Test constant velocity (1000 m/s) halo 20" begin
            # constant velocity setup
            c0 = 1000.0
            nt = 2000
            nx = 1001
    ...
    @testset "Test 2D analytical solution" begin
        ...
        @testset "Test 2D constant velocity (1000 m/s) halo 0" begin
            # constant velocity setup
            c0 = 1000.0
            nt = 1200
            nx = ny = 401
        ...
        @testset "Test 2D constant velocity (1000 m/s) halo 20" begin
            # constant velocity setup
            c0 = 1000.0
            nt = 1200 
            nx = ny = 401
    ...
    @testset "Test 3D analytical solution" begin
        @testset "Test 3D constant velocity (1000 m/s) halo 0" begin
            # constant velocity setup
            c0 = 1000.0
            nt = 1200
            nx = ny = nz = 101
        ...
        @testset "Test 3D constant velocity (1000 m/s) halo 20" begin
            # constant velocity setup
            c0 = 1000.0
            nt = 1200
            nx = ny = nz = 101
