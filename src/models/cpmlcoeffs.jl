...
function compute_CPML_coefficientsAxis!(
    ...
    a_l, a_r, b_l, b_r = calc_Kab_CPML2(halo, dt, npower, d0, alpha_max, "ongrd")
    a_hl, a_hr, b_hl, b_hr = calc_Kab_CPML2(halo, dt, npower, d0, alpha_max, "halfgrd")
